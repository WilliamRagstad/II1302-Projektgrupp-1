...
const serviceAccountKey = {
  ...
  "client_email":
    "firebase-adminsdk-z01bv@airdash-eb4f7.iam.gserviceaccount.com",
  "client_id": "102917941246526003540",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url":
    "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-z01bv%40airdash-eb4f7.iam.gserviceaccount.com",
};
...
Deno.test({
  ...
  async fn() {
    var response = await client.Firestore.CreateDocument(
      "CreateDocumentTest",
      "test",
      {
        lat: {
